...
namespace LAB09
{
    ...
    class MyTextTests
    {
        ...
        {
            MyText txt = new MyText();
            StringAssert.StartsWith("Parabéns", txt.Concat("Parabéns concluído com ", "sucesso"));
        }
        ...
        {
            MyText txt = new MyText();
            StringAssert.IsMatch("sucesso", txt.Concat("A ligação ", "foi estabelecida com sucesso."));
        }
    }
}
